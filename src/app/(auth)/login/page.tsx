...
const ERROR_MESSAGES: Record<string, string> = {
    link_expired: "Doğrulama linki süresi dolmuş. Lütfen tekrar kayıt olun veya yeni doğrulama maili isteyin.",
    auth_callback_failed: "Kimlik doğrulama başarısız oldu. Lütfen tekrar deneyin.",
    missing_code: "Geçersiz doğrulama linki. Lütfen tekrar deneyin.",
};
