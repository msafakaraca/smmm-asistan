/**
 * KDV2 Kontrol Bulk Status API
 *
 * POST: Seçilen müşterilerin KDV2 kontrol durumlarını toplu güncelle
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error("[kdv2-kontrol/bulk-status] Error:", error);
    return NextResponse.json(
