/**
 * SGK Kontrol Bulk Status API
 *
 * POST: Seçilen müşterilerin SGK kontrol durumlarını toplu güncelle
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    const statusLabels: Record<string, string> = {
      ...
      dilekce_gonderildi: "Dilekçe Gönderildi",
    };
    ...
    console.error("[sgk-kontrol/bulk-status] Error:", error);
    return NextResponse.json(
