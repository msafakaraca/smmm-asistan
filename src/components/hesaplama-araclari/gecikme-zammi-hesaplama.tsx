...
const GECIKME_TIPLERI = [
    { label: "Gecikme Zammı", value: "1" },
    { label: "Gecikme Faizi", value: "2" },
];
...
export function GecikmeZammiHesaplama() {
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm mt-1">
                            GİB üzerinden gecikme zammı ve faizi hesaplayın
                        </p>
                    </div>
                </div>
                {(hasInput || hasResults) && (
                ...
                <div className="flex flex-col gap-3">
                    <Card className="flex-1">
                        ...
                        <CardContent className="text-sm text-muted-foreground space-y-4 pt-0">
                            <p>
                                Vadesinde ödenmeyen vergi borçlarına, vade tarihinden
                                ödeme tarihine kadar geçen süre için uygulanan ek
                                mali yükümlülüktür.
                            </p>
                            ...
                            <div>
                                ...
                                <ul className="list-disc list-inside space-y-1">
                                    <li>
                                        <strong>Gecikme Zammı:</strong> 6183 s. Kanun m.51 -
                                        vadesinde ödenmeyen amme alacaklarına uygulanan zam
                                    </li>
                                    <li>
                                        <strong>Gecikme Faizi:</strong> 213 s. VUK m.112 -
                                        ikmalen, re&apos;sen veya idarece yapılan tarhiyatlarda
                                        uygulanan faiz
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="border-t pt-3 space-y-3">
                                <div>
                                    <p className="font-medium text-foreground mb-1">Gecikme Zammı Oranı</p>
                                    <p>
                                        Cumhurbaşkanlığı Kararı ile belirlenir.
                                        Her ay için ayrı oran uygulanabilir.
                                    </p>
                                </div>
                                <div>
                                    <p className="font-medium text-foreground mb-1">Hesaplama Yöntemi</p>
                                    <p>
                                        Her ay ve ay kesri için ayrı ayrı hesaplanır.
                                        Ay kesirleri tam ay olarak dikkate alınır.
                                    </p>
                                </div>
                                <div>
