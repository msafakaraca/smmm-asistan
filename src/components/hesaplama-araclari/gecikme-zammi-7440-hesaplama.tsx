...
const GECIKME_TIPLERI = [
    { label: "Gecikme Zammı (Yİ-ÜFE Bazlı)", value: "12" },
    { label: "Gecikme Faizi (Yİ-ÜFE Bazlı)", value: "13" },
];
...
export function GecikmeZammi7440Hesaplama() {
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">
                            Gecikme Zammı / Faizi - 7440 Sayılı Kanun
                        </h1>
                        <p className="text-muted-foreground text-sm mt-1">
                            7440 sayılı Yapılandırma Kanunu kapsamında Yİ-ÜFE bazlı hesaplama
                        </p>
                    </div>
                </div>
                {(hasInput || hasResults) && (
                ...
                <div className="flex flex-col gap-3">
                    <Card className="flex-1">
                        ...
                        <CardContent className="text-sm text-muted-foreground space-y-4 pt-0">
                            <p>
                                7440 sayılı &quot;Bazı Alacakların Yeniden Yapılandırılması ile
                                Bazı Kanunlarda Değişiklik Yapılmasına Dair Kanun&quot; kapsamında
                                yapılandırma başvurusu yapan mükellefler için Yİ-ÜFE
                                bazlı gecikme hesaplaması yapılır.
                            </p>
                            ...
                            <div>
                                ...
                                <ul className="list-disc list-inside space-y-1">
                                    <li>
                                        <strong>Gecikme Zammı (Yİ-ÜFE):</strong> Yapılandırma
                                        kapsamında Yİ-ÜFE aylık değişim oranları ile hesaplanan tutar
                                    </li>
                                    <li>
                                        <strong>Gecikme Faizi (Yİ-ÜFE):</strong> Yapılandırma
                                        kapsamında Yİ-ÜFE aylık değişim oranları ile hesaplanan tutar
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="border-t pt-3 space-y-3">
                                <div>
                                    <p className="font-medium text-foreground mb-1">Yİ-ÜFE Nedir?</p>
                                    <p>
                                        TÜİK tarafından aylık olarak açıklanan Yurt İçi
                                        Üretici Fiyat Endeksi&apos;dir.
                                    </p>
                                </div>
                                <div>
                                    <p className="font-medium text-foreground mb-1">Yapılandırma Avantajı</p>
                                    <p>
                                        Gecikme zammı/faizi yerine daha düşük oranlı
                                        Yİ-ÜFE bazlı hesaplama ile mükellefe avantaj sağlanır.
                                    </p>
                                </div>
                                <div>
