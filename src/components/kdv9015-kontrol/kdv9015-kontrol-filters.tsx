...
/**
 * KDV9015 Kontrol Filters Component
 *
 * Dönem seçimi, arama ve filtreler (mor tema).
 */
...
interface Kdv9015KontrolFiltersProps {
  selectedYear: number;
...
export const Kdv9015KontrolFilters = memo(function Kdv9015KontrolFilters({
  selectedYear,
  setSelectedYear,
  selectedMonth,
  setSelectedMonth,
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          {onToggleSelectionMode && (
            <Button
              ...
              className={isSelectionMode ? "bg-purple-600 hover:bg-purple-700" : ""}
            >
      ...
      <AlertDialog open={showClearConfirm} onOpenChange={setShowClearConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {selectedYear}/{String(selectedMonth).padStart(2, "0")} donemine ait
              tum KDV Tevkifat kontrol verileri silinecek. Bu islem geri alinamaz.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
