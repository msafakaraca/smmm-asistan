...
/**
 * KDV2 Kontrol Filters Component
 *
...
interface Kdv2KontrolFiltersProps {
  selectedYear: number;
...
export const Kdv2KontrolFilters = memo(function Kdv2KontrolFilters({
  selectedYear,
  setSelectedYear,
  selectedMonth,
  setSelectedMonth,
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              tüm KDV-2 kontrol verileri silinecek. Bu işlem geri alınamaz.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
